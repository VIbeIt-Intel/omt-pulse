...
export const USER_ROLES = ["administrator", "control_room", "supervisor", "reporter", "access_controller"] as const;
...
export function usesLocationAssignmentScope(role: string): boolean {
  return role === "supervisor" || role === "control_room" || role === "reporter" || role === "access_controller";
}
